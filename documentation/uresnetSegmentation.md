```markdown
Help on class UResNetSegmentation in module spine.model.uresnet:

class UResNetSegmentation(torch.nn.modules.module.Module)
 |  UResNetSegmentation(uresnet, uresnet_loss=None)
 |  
 ...
 |  
 |  __init__(self, uresnet, uresnet_loss=None)
 ...
 |  
 |  process_model_config(self, num_classes, ghost=False, **backbone)
