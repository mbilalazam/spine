```markdown
Help on class SegmentationLoss in module spine.model.uresnet:

class SegmentationLoss(torch.nn.modules.loss._Loss)
 |  SegmentationLoss(uresnet, uresnet_loss)
 |  
 ...
 |  
 |  __init__(self, uresnet, uresnet_loss)
 ...
 |          Loss configuration
 |  
 |  forward(self, seg_label, segmentation, ghost=None, weights=None, **kwargs)
 ...
 |  
 |  loss_accuracy(self, logits, labels, weights=None)
 ...
 |  
 |  process_loss_config(self, ghost_label=-1, alpha=1.0, beta=1.0, balance_loss=False)
 ...
 |  
 |  process_model_config(self, num_classes, ghost=False, **kwargs)
